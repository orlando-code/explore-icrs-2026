...
happened. Any command that changes the database snapshots it first.
    ...
    python scripts/manage_offset_registrations.py stats
    python scripts/manage_offset_registrations.py list --status pending
    ...
    python scripts/manage_offset_registrations.py revoke-matching --client 49e8159 --reason "scripted burst"
"""
