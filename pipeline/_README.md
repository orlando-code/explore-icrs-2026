...
data/geography/        -> country boundaries, neighbours, national per-capita
...
| **geography/** `country_boundaries.geojson`, `country_boundaries_centroids.json`, `country_neighbours.json`, `country_continents.json`, `national_per_capita_co2.json` | Choropleth + clustering | **Static** – not regenerated by `build_pipeline.py` |
